...
public class FileController {
    ...
    public Result<FileInfoDTO> uploadFile(
        ...
        try {
            ...
            FileInfoDTO result = fileService.uploadFile(file, uploadDTO, replaceOld);
    ...
    public Result<FileInfoDTO> uploadTempFile(
        ...
        try {
            ...
            FileInfoDTO result = fileService.uploadTempFile(file);
            return Result.success(result);
    ...
    public Result<FileInfoDTO> uploadTempBusinessFile(
        ...
        try {
            ...
            FileInfoDTO result = fileService.uploadFile(file, uploadDTO, false);
            return Result.success(result);
