/*
 ...
 Source Schema         : gym_booking_system

 Target Server Type    : MySQL
 Target Server Version : 80043 (8.0.43)
 File Encoding         : 65001

 Date: 28/10/2025 16:59:12
*/
...
-- ----------------------------
INSERT INTO `gym_course_booking` VALUES (1, 1, 25, '2025-10-28 12:57:19', 68.00, 68.00, 1.00, 0, '2025-10-28 13:15:26', '2025-10-28 12:57:18', '2025-10-28 12:57:18');
...
-- ----------------------------
INSERT INTO `gym_user_membership` VALUES (1, 1, 1, 1, '2025-10-28 09:42:08', '2025-11-27 09:42:08', 199.00, 1, '2025-10-28 09:42:08', '2025-10-28 09:42:08', '2025-10-28 09:42:08');
INSERT INTO `gym_user_membership` VALUES (2, 1, 1, 1, '2025-11-27 09:42:08', '2025-12-27 09:42:08', 199.00, 1, '2025-10-28 15:11:23', '2025-10-28 15:11:22', '2025-10-28 15:11:22');
...
) ENGINE = InnoDB AUTO_INCREMENT = 40 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '文件信息表-精简版' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `user`  (
  ...
  `userType` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1' COMMENT '用户类型：USER小程序用户，ADMIN管理员，COACH教练',
  ...
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_user_userType`(`userType` ASC) USING BTREE,
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '统一用户表（包含小程序用户和管理员）' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'USER', '张三1', '/files/bussiness/user_avatar/1761634887253.jpg', '13800138001', 1, '2025-12-27 09:42:08', 'test', '$2a$10$rl4PIkQ5pVfFly62C2MFhuyleBXtSOM40wknY7caK0D3fFjHkfNIa', '17961456@qq.com', 1, '2025-10-17 09:19:31', '2025-10-28 16:09:53');
INSERT INTO `user` VALUES (2, 'USER', '李四', '/images/avatar2.jpg', '13800138002', 1, '2024-02-17 23:59:59', 'user1', '$10$lqnSaaWggBoGo5BftUKuX.hmQzk3yNF4UqC5H47AeySo5KOEg6MEC', NULL, 1, '2025-10-17 09:19:31', '2025-10-28 09:22:50');
INSERT INTO `user` VALUES (3, 'USER', '王五', '/images/avatar3.jpg', '13800138003', 2, '2024-03-17 23:59:59', 'user2', '$10$lqnSaaWggBoGo5BftUKuX.hmQzk3yNF4UqC5H47AeySo5KOEg6MEC', NULL, 1, '2025-10-17 09:19:31', '2025-10-28 09:22:51');
INSERT INTO `user` VALUES (4, 'USER', '赵六', '/images/avatar4.jpg', '13800138004', 0, NULL, 'user3', '$10$lqnSaaWggBoGo5BftUKuX.hmQzk3yNF4UqC5H47AeySo5KOEg6MEC', NULL, 1, '2025-10-17 09:19:31', '2025-10-28 09:22:51');
INSERT INTO `user` VALUES (5, 'ADMIN', '系统管理员', '/files/bussiness/user_avatar/1761636869026.jpg', '13900139001', 0, NULL, 'admin', '$2a$10$0EB8hAzCT25cUhNeXDOhkujD./0TYjjiENnpirImJg4q4MeE/pKPa', 'admin@gym.com', 1, '2025-10-17 09:19:31', '2025-10-28 15:34:33');
INSERT INTO `user` VALUES (6, 'ADMIN', '健身房经理', NULL, '13900139002', 0, NULL, 'manager', '$10$lqnSaaWggBoGo5BftUKuX.hmQzk3yNF4UqC5H47AeySo5KOEg6MEC', 'manager@gym.com', 1, '2025-10-17 09:19:31', '2025-10-28 09:22:58');
...
CREATE TABLE `gym_training_action`  (
  ...
  INDEX `idx_status`(`status` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '训练动作库' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '体测数据表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '训练计划表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '训练计划明细表' ROW_FORMAT = Dynamic;
